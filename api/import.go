...
func ImportIncomingWebhook(hookUser *model.User, channel *model.Channel) (*model.IncomingWebhook, error) {
	hook := model.IncomingWebhook{
		UserId:      hookUser.Id,
		ChannelId:   channel.Id,
		TeamId:      channel.TeamId,
		DisplayName: utils.T("api.import.import_incoming_webhook.display_name"),
		Description: utils.T("api.import.import_incoming_webhook.description"),
	}
